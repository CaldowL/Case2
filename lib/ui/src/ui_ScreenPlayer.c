...
void ui_ScreenPlayer_screen_init(void)
{
    ...
    lv_obj_clear_flag(ui_ScreenPlayer, LV_OBJ_FLAG_SCROLLABLE);      /// Flags

    ui_Image5 = lv_img_create(ui_ScreenPlayer);
    ...
    ui_Container1 = lv_obj_create(ui_ScreenPlayer);
    ...
    ui_Container2 = lv_obj_create(ui_ScreenPlayer);
    ...
    ui_Container3 = lv_obj_create(ui_ScreenPlayer);
    ...
    ui_Slider2 = lv_slider_create(ui_ScreenPlayer);
    ...
    ui_Label8 = lv_label_create(ui_ScreenPlayer);
    ...
    uic_ScreenMusic = ui_ScreenPlayer;
    uic_Slider2 = ui_Slider2;
    uic_Label8 = ui_Label8;

}

void ui_ScreenPlayer_screen_destroy(void)
{
    if(ui_ScreenPlayer) lv_obj_del(ui_ScreenPlayer);

    // NULL screen variables
    uic_ScreenMusic = NULL;
    ui_ScreenPlayer = NULL;
    ui_Image5 = NULL;
    ui_Container1 = NULL;
    ui_Label1 = NULL;
    ui_Slider1 = NULL;
